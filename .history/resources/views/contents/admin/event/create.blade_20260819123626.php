...
<div class="col-12">
    <div class="card shadow mb-4 border-bottom-primary">
        ...
        <div class="form-group">
            <label for="">تاريخ الحدث</label>
                        <input name="start_date" type="date" class="form-control col-lg-6" id="start_date"
                        ...
                        @enderror
                 <label for="">تاريخ انتهاء الحدث</label>
                        <input name="end_date" type="date" class="form-control col-lg-6" id="end_date"
