 ...
 <tbody> 
    @foreach ($events as $event)
      <tr>
        ...
        <td><img src="/course/{{$event->image}}" alt="Main Image" style="max-width: 50px; max-height: 50px;">
      <img src="{{ asset('storage/files/events/' . $event->image) }}" style="max-width: 50px; max-height: 50px;">
      </td>
      </tr>           
            @endforeach
      </tbody>
