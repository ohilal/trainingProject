...
<div class="col">
  <div class="card ">
    <!-- <img class="card-img-top img-responsive" src="/course/file.png" alt="Card image" > -->
      ...
      <img src="{{ asset('storage/files/events/' . $event->image) }}" class="card-img-top img-responsive custom-crop"  alt="{{ $event->title }}"  >
    ...
    <div class="card-body ">
            <div class="card-title h4" data-filter="{{ $event['id'] }}">{{ $event['title'] }} </div>
           <i class="fa fa-calendar-alt text-muted"> </i> <small class="text-muted text-italic"> {{ $event['start_date'] }}   </small>
