<div class="col-lg-4 col-md-6 portfolio-item department-{{ $course->Department->id }} wow fadeInUp" data-wow-delay="0.1s">
    <div class="rounded overflow-hidden">
        ...
        <div class="bg-light p-4">
            ...
            <a href="{{ route('front.course', $course->id) }}" class="btn rounded-pill btn-darkteal col-lg-4 py-2 px-4 ms-3 d-none d-lg-block <ul class="list-inline mb-5" id="portfolio-flters">
