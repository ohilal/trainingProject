...
Route::group(['prefix' => 'front', 'as' => 'front.'], function () {
      // The {id} captures the department ID from the URL
    Route::get('/department/{id}', [CourseController::class, 'byDepartment'])->name('courses.byDepartment'); 
    ...
    // Public route to view department courses
Route::get('/department/{id}', [FrontCourseController::class, 'byDepartment'])->name('front.department.show');

// Admin resource routes (keep existing)
...
Route::prefix('panel')->middleware(['verified'])->group(function () {
    ...
    Route::get('/admin/events', [EventController::class, 'adminIndex'])->name('admin.event.index');
