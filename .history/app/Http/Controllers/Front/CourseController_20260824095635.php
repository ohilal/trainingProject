...
{
    // Find the department or fail with 404
    $department = \App\Models\Department::findOrFail($id);
    
    // Get courses for this specific department
    $courses = $department->courses()->get(); 
    
    // Return the view (ensure this view file exists)
    return view('contentsfront.courses.index', compact('department', 'courses'));
}
}
